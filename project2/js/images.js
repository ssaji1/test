...
for(count=0;count<images.length;count++)
    {
        var list=$('<li/>');                                          //create <li> tag
        var src=images[count].path;                                     //set path property as src of <img> tag
        var alt=images[count].title;                                    //set title proprty as alt of <img> tag
        var img=$('<img src="images/square/'+src+'" alt="'+alt+'">');   //create <img> tag
        list.append(img);                                              // Add <img> tag to <li> tag
        $('.gallery').append(list);                                       // Add <li> to <ul> tag
    }
